    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int i = 0; i < depts.size(); i++) {
                Map<String, Object> deptMap = depts.get(i);
                List<Object> list = new ArrayList<>();
                for (String s : str) {
                    list.add(deptMap.get(s));
                }
                rowList.add(list);
                onlyKeys.add(i + "");
            }
            ...
            for (int i = 0; i < onlyKeys.size(); i++) {
                ...
                Map<String, Object> stringObjectMap = depts.get(i);

                List<Map<String, Object>> listMap = (List<Map<String, Object>>) stringObjectMap.get(testUsers);
